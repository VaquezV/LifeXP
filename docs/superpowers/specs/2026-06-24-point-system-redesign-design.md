...
- N1 : `[{pct:80,pts:1},{pct:85,pts:2},{pct:90,pts:3},{pct:95,pts:4},{pct:99,pts:5}]`
- N2 : `[{pct:82,pts:1},{pct:87,pts:2},{pct:92,pts:3},{pct:97,pts:4},{pct:99,pts:5}]`
- N3 : `[{pct:84,pts:1},{pct:89,pts:2},{pct:94,pts:3},{pct:98,pts:4},{pct:99,pts:5}]`
- N4 : `[{pct:86,pts:1},{pct:91,pts:2},{pct:96,pts:3},{pct:98,pts:4},{pct:99,pts:5}]`
- N5 : `[{pct:95,pts:1},{pct:96pts:2},{pct:97pts:3},{pct:98pts:3},{pct:99pts:5}]`
...
| Condition (évaluée dans l'ordre) | Score avatar |
| -------------------------------- | ------------ |
| Toutes les 4 catégories à N1     | 5            |
| ≥ 1 catégorie à N2               | 15           |
...
| Limite atteinte (count = max_habits)   | `+` actif, style "bloqué" (opacity réduite ou icône lock) | Toast : *"Niveau N[+1] requis pour ajouter une habitude ici"* |
